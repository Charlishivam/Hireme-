...
<div class="content-wrapper">
   ...
   <section class="content">
      <div class="card card-default">
         ...
         <div class="card-body">
            <form method="POST" action="<?= base_url()."admin/service/edit/".$single['service_id'] ?>" enctype="multipart/form-data">
            <input type="hidden" name="service_id" value="<?= $single['service_id'] ?>">
               <div class="card-body">
                    <div class="form-group row">
                     ...
                     <div class="col-lg-10">
                        <?= form_dropdown('customer_id',$customer_name,set_value('customer_id',$single['customer_id']),'class="form-control" id="kt_select2_7"'); ?>
                  ...
                  <div class="form-group row">
                     ...
                     <div class="col-lg-10">
                        <?= form_dropdown('service_category',$category_name,set_value('service_category',$single['service_category']),'class="form-control" id="kt_select2_1"'); ?>
                  ...
                  <div class="form-group row">
                     ...
                     <div class="col-lg-10">
                        <?= form_dropdown('service_subcategory',$subcategory_name,set_value('service_subcategory',$single['service_subcategory']),'class="form-control" id="kt_select2_2"'); ?>
                  ...
                  <div class="form-group row mt-3">
                     ...
                     <div class="col-lg-10">
                        <input type="text" name="service_title" class="form-control" required="" placeholder="Title" value="<?= set_value('service_title',$single['service_title']) ?>" />
                  ...
                  <div class="form-group row mt-3">
                     ...
                     <div class="col-lg-10">
                        <input type="text" name="service_price" class="form-control" required="" placeholder="service price" value="<?= set_value('service_price',$single['service_price']) ?>" />
                ...
                <div class="form-group row mt-3">
                     ...
                     <div class="col-lg-10">
                        <input type="text" name="service_delivery" class="form-control" required="" placeholder="service_delivery" value="<?= set_value('service_delivery',$single['service_delivery']) ?>" />
                  ...
                  <div class="form-group row">
                     ...
                     <div class="col-lg-10">
                        <textarea type="text" class="form-control"  name="service_description"><?= $single['service_description'] ?></textarea>
                     ...
                     <div class="col-lg-3">
                        <div class="input-group">
                           <div class="image-input image-input-outline" id="kt_image_1">
                              <div class="image-input-wrapper" style="background-image: url((<?= base_url($single['service_image'] ); ?>)"></div>
