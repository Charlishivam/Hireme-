   ...
   <section class="content">
      <div class="card card-default">
         ...
         <div class="card-body">
            ...
            <form method="POST" action="<?= base_url()."admin/audition/edit/".$single['audition_id'] ?>" enctype="multipart/form-data">

               <input type="hidden" name="audition_id" value="<?php echo $single['audition_id'] ?>">
               <div class="card-body">
                  <div class="form-group row mt-3">
                     <label class="col-lg-2 col-form-label text-lg-right"><span class="text-red" style="color:red">*</span> Season Name:</label>
                     <div class="col-lg-10">
                        <?= form_dropdown('audition_season_id',$season_name,set_value('audition_season_id',$single['audition_season_id']),'class="form-control" id="kt_select2_1"') ?>
                  ...
                  <div class="form-group row">
                     ...
                     <div class="col-lg-4">
                        <div class="input-group">
                           <input type="text" name="audition_start_date" class="form-control" autocomplete="false"  id="kt_datepicker_3" placeholder="Start Date" value="<?= set_value('audition_start_date',$single['audition_start_date']) ?>" />
                     ...
                     <div class="col-lg-4">
                        <div class="input-group">
                           <input type="text" autocomplete="false" name="audition_end_date" class="form-control"  id="kt_datepicker_3" placeholder="End Date" value="<?= set_value('audition_end_date',$single['audition_end_date']) ?>" />
                     ...
                     <div class="col-lg-10">
                        <div class="input-group">
                           <div class="image-input image-input-outline" id="kt_image_1">
                              <div class="image-input-wrapper" style="background-image: url(<?= base_url($single['audition_image']); ?>)"></div>
