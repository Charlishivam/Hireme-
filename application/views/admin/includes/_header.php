...
<html lang="en">
   ...
   <head>
      <meta charset="utf-8" />
      <title><?= isset($title)? $title.' - ' : 'Title -' ?><?= isset($this->general_settings['application_name'])?$this->general_settings['application_name']:''; ?></title>
      <meta name="description" content="Stream Live" />
      ...
      <link href="<?= base_url()?>assets/plugins/custom/datatables/datatables.bundle.css?v=7.2.8" rel="stylesheet" type="text/css" />
      ...
      <link href="<?= base_url()?>assets/css/themes/layout/aside/dark.css" rel="stylesheet" type="text/css" />
       ...
       <script src="<?= base_url() ?>assets/js/pages/features/miscellaneous/sweetalert2.js?v=7.2.8"></script>
       <!--end::Layout Themes-->
                     ...
                     <div class="topbar">
                        ...
                        <div class="topbar-item">
                           <div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
                              ...
                              <span class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3"><?= ucwords($this->session->userdata('username')); ?></span>
