      ...
      <div class="card card-default">
         <div class="card-header">
            ...
            <div class="d-inline-block float-right">
               <a href="<?= base_url('admin/jobpost'); ?>" class="btn btn-success"><i class="fa fa-list"></i>  Job Post List</a>
            </div>
         </div>
         <?php $skill=json_decode($single['jobpost_skill']); ?>
         <div class="card-body">
            <form method="POST" action="<?= base_url()."admin/jobpost/edit/".$single['jobpost_id'] ?>" enctype="multipart/form-data">
            <input type="hidden" name="jobpost_id" value="<?= $single['jobpost_id'] ?>">
               <div class="card-body">
                  ...
                  <div class="form-group row">
                     ...
                     <div class="col-lg-10">
                        <?= form_dropdown('jobpost_category',$category_name,set_value('jobpost_category',$single['jobpost_category']),'class="form-control" id="kt_select2_1"'); ?>
                  ...
                  <div class="form-group row">
                     ...
                     <div class="col-lg-10">
                        <?= form_dropdown('jobpost_subcategory',$subcategory_name,set_value('jobpost_subcategory',$single['jobpost_subcategory']),'class="form-control" id="kt_select2_2"'); ?>
                  ...
                  <div class="form-group row mt-3">
                     ...
                     <div class="col-lg-10">
                        <input type="text" name="jobpost_title" class="form-control" required="" placeholder="Title" value="<?= set_value('jobpost_title',$single['jobpost_title']) ?>" />
                  ...
                  <div class="form-group row mt-3">
                     ...
                     <div class="col-lg-10">
                        <input type="text" name="jobpost_till_date" class="form-control"  id="kt_datepicker_3" placeholder="Post Till Date" value="<?= set_value('jobpost_till_date',$single['jobpost_till_date']) ?>" />
                  ...
                  <div class="form-group row mt-3">
                     ...
                     <div class="col-lg-10">
                        <input type="text" name="jobpost_summary" class="form-control"  id="" placeholder="Summary" value="<?= set_value('jobpost_summary',$single['jobpost_summary']) ?>" />
                  ...
                  <div class="form-group row mt-3">
                     ...
                     <div class="col-lg-4">
                        <input type="number" class="form-control" name="jobpost_price_from" placeholder="From Price" required="" value="<?= set_value('jobpost_price_from',$single['jobpost_price_from']) ?>"/>
                     ...
                     <div class="col-lg-4">
                        <input type="number" class="form-control" name="jobpost_praposal" placeholder="Praposal" required="" value="<?= set_value('jobpost_praposal',$single['jobpost_praposal']) ?>"/>
                  ...
                  <div class="form-group row">
                     ...
                     <div class="col-lg-10">
                        <?= form_dropdown('jobpost_skill[]',$skill_name,set_value('jobpost_skill[]',$skill),'class="form-control" id="kt_select2_7" multiple="multiple" required') ?>
                  ...
                  <div class="form-group row">
                     ...
                     <div class="col-lg-10">
                        <textarea type="text" class="form-control"  name="jobpost_description"><?= $single['jobpost_description']?></textarea>
