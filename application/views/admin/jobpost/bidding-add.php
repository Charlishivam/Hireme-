      ...
      <div class="card card-default">
         <div class="card-header">
            ...
            <div class="d-inline-block float-right">
               <a href="<?= base_url('admin/jobpost/view/'.$jobpost_id); ?>" class="btn btn-success"><i class="fa fa-list"></i>Bidding List</a>
            </div>
         </div>
         <div class="card-body">
            <form method="POST" action="<?= base_url()."admin/jobpost/bidding_add/".$jobpost_id ?>" enctype="multipart/form-data">
               ...
               <div class="card-body">
                  <div class="form-group row mt-3">
                     ...
                     <div class="col-lg-10">
                        <?= form_dropdown('bidding_customer_id',$customer_name,set_value('bidding_customer_id'),'class="form-control" id="kt_select2_4"'); ?>
                  ...
                  <div class="form-group row mt-3">
                     ...
                     <div class="col-lg-10">
                        <input type="text" name="bidding_amount" required="" class="form-control" id="bidding_amount" value="<?= set_value('bidding_amount') ?>" placeholder="customer bidding amount">
                  ...
                  <div class="form-group row mt-3">
                     ...
                     <div class="col-lg-10">
                        <?= form_dropdown('bidding_shortlist',[''=>'Select Short List','0'=>'No','1'=>'Yes'],set_value('bidding_shortlist'),'class="form-control" id="kt_select2_1"'); ?>
                  ...
                  <div class="form-group row mt-3">
                     ...
                     <div class="col-lg-10">
                        <textarea name="bidding_comment" class="form-control"></textarea>
