...
<div class="content-wrapper">
   ...
   <section class="content">
      <div class="card card-default">
         ...
         <div class="card-body">
             <form method="POST" action="<?= base_url()."admin/customer/edit/".$single['customer_id'] ?>" enctype="multipart/form-data">
              
               <input type="hidden" name="customer_id" value="<?= $single['customer_id'] ?>">
               <div class="card-body">
                  <!--<div class="form-group row">-->
                  <!--   <label class="col-lg-2 col-form-label text-lg-right">Customer Type:</label>-->
                  <!--   <div class="col-lg-10">-->
                  <!--      <?= form_dropdown('customer_type',[''=>'Select Customer Type','0'=>'Normal User','1'=>'Service Provider'],set_value('customer_type',$single['customer_type']),'class="form-control" id="kt_select2_1"'); ?>-->
                  ...
                  <div class="form-group row mt-3">
                     ...
                     <div class="col-lg-4">
                        <input type="text" name="customer_first_name" class="form-control" required="" placeholder="First name" value="<?= set_value('customer_first_name',$single['customer_first_name']) ?>" />
                        <span class="form-text text-muted">Please enter your first name</span>
                     </div>
                     <label class="col-lg-2 col-form-label text-lg-right"><span class="text-red"  style="color:red">*</span> Last Name:</label>
                     <div class="col-lg-4">
                        <input type="text" class="form-control" name="customer_last_name" placeholder="Last name" required="" value="<?= set_value('customer_last_name',$single['customer_last_name']) ?>"/>
                  ...
                  <div class="form-group row mt-3">
                     ...
                     <div class="col-lg-4">
                        <input type="text" class="form-control" name="customer_mobile" placeholder="Enter contact number" required="" value="<?= set_value('customer_mobile',$single['customer_mobile']) ?>"/>
                     ...
                     <div class="col-lg-4">
                        <input type="email" class="form-control" name="customer_email" placeholder="Email" required="" value="<?= set_value('customer_email',$single['customer_email']) ?>"/>
                  ...
                  <div class="form-group row mt-3">
                     ...
                     <div class="col-lg-4">
                        <div class="input-group">
                           ...
                           <input type="text" class="form-control" name="customer_username"  placeholder="" required="" value="<?= set_value('customer_username',$single['customer_username']) ?>" />
                        </div>
                        <span class="form-text text-muted">Please enter your username</span>
                     </div>
                     <label class="col-lg-2 col-form-label text-lg-right"><span class="text-red" style="color:red">*</span>Password:</label>
                     <div class="col-lg-4">
                        <input type="password" class="form-control" name="customer_password" placeholder="Password" required="" value="<?= set_value('customer_password',$single['customer_password']) ?>"/>
                  ...
                  <div class="form-group row">
                     ...
                     <div class="col-lg-4">
                        <div class="input-group">
                           <input type="text" class="form-control" name="customer_address1" id="address" placeholder="Enter your 1st address" required="" value="<?= set_value('customer_address1',$single['customer_address1']) ?>"/>
                           <input type="hidden" id="lat" name="customer_lat" value="<?= set_value('customer_lat',$single['customer_lat']) ?>">
                           <input type="hidden" id="lng" name="customer_long" value="<?= set_value('customer_long',$single['customer_long']) ?>">
                           <input type="hidden" id="zipcode" name="customer_pincode" value="<?= set_value('customer_pincode',$single['customer_pincode']) ?>">
                     ...
                     <div class="col-lg-4">
                        <div class="input-group">
                           <input type="text" class="form-control" name="customer_address2" placeholder="Enter your 2nd address" value="<?= set_value('customer_address2',$single['customer_address2']) ?>"/>
                           <div class="input-group-append">
                              <span class="input-group-text">
                              <i class="la la-map-marker"></i>
                              </span>
                  ...
                  <div class="form-group row">
                     ...
                     <div class="col-lg-4">
                        <input type="text" class="form-control" name="customer_state" placeholder="Enter State Name" value="<?= set_value('customer_state',$single['customer_state']) ?>" />
                        <span class="form-text text-muted">Please enter your state</span>
                     </div>
                     <label class="col-lg-2 col-form-label text-lg-right">City:</label>
                     <div class="col-lg-4">
                        <div class="input-group">
                           <input type="text" class="form-control" name="customer_city" id="city" placeholder="Enter your City Name" value="<?= set_value('customer_city',$single['customer_city']) ?>" />
                  ...
                  <div class="form-group row">
                     ...
                     <div class="col-lg-4">
                        <div class="input-group">
                           <input type="text" class="form-control" name="customer_flatno" placeholder="Enter Flat/House/Office No" value="<?= set_value('customer_flatno',$single['customer_flatno']) ?>" />
                        </div>
                     ...
                     <div class="col-lg-4">
                        <input type="text" class="form-control" name="customer_landmark" placeholder="Enter Landmark Number" value="<?= set_value('customer_landmark',$single['customer_landmark']) ?>" />
                  ...
                  <div class="form-group row">
                     ...
                     <div class="col-lg-4">
                        <div class="input-group">
                           <input type="text" name="customer_dob" class="form-control"  id="kt_datepicker_3" placeholder="DOB" value="<?= set_value('customer_dob',$single['customer_dob']) ?>" />
                     ...
                     <div class="col-lg-4">
                        <div class="radio-inline">
                           ...
                           <input type="radio" name="customer_gender" <?php if($single['customer_gender'] == "0") echo"checked"; ?> value="0" />
                           <span></span>Male</label>
                           <label class="radio radio-solid">
                           <input type="radio" name="customer_gender" <?php if($single['customer_gender'] == "1") echo"checked"; ?> value="1" />
                  ...
                  <div class="form-group row">
                     ...
                     <div class="col-lg-10">
                        <textarea type="text" class="form-control"  name="customer_work_experience"><?= $single['customer_work_experience'] ?></textarea>
                  ...
                  <div class="form-group row">
                     ...
                     <div class="col-lg-10">
                        <textarea type="text" class="form-control"  name="customer_description"><?= $single['customer_description'] ?></textarea>
                     ...
                     <div class="col-lg-4">
                        <div class="input-group">
                           <div class="image-input image-input-outline" id="kt_image_1">
                              <div class="image-input-wrapper" style="background-image: url(<?= base_url($single['customer_image']); ?>)"></div>
