...
<div class="content-wrapper">
   ...
   <section class="content">
      <div class="card card-default">
         ...
         <div class="card-body">
            <?php echo form_open_multipart(base_url('admin/locality/edit/' .$single['locality_id']), 'class="form-horizontal"');  ?>
            <input type="hidden" name="locality_id" value="<?= $single['locality_id'] ?>">
               <div class="card-body">
                  <div class="form-group row mt-3">
                     <label class="col-lg-2 col-form-label text-lg-right"><span class="text-red" style="color:red">*</span> State Name:</label>
                     <div class="col-lg-5">
                        <?= form_dropdown('locality_state_id',$all_state,set_value('locality_state_id',$single['locality_state_id']),'class="form-control" id="kt_select2_2"') ?>
                  ...
                  <div class="form-group row mt-3">
                     ...
                     <div class="col-lg-5">
                        <?= form_dropdown('locality_city_id',$all_city,set_value('locality_city_id',$single['locality_city_id']),'class="form-control" id="kt_select2_1"') ?>
                  ...
                  <div class="form-group row mt-3">
                     ...
                     <div class="col-lg-5">
                        ...
                        <input type="text" name="locality_name" required="" class="form-control" id="locality_name" value="<?= set_value('locality_name',$single['locality_name']) ?>" placeholder="locality Name">
