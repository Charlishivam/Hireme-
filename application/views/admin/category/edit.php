...
<div class="content-wrapper">
   ...
   <section class="content">
      <div class="card card-default">
         ...
         <div class="card-body">
            <form method="POST" action="<?= base_url()."admin/category/edit/".$single['category_id'] ?>" enctype="multipart/form-data">
            <input type="hidden" name="category_id" value="<?= set_value('category_id',$single['category_id']) ?>" >
            <div class="row">
               <div class="col-md-12">
                   <div class="form-group">
                     <label for="title" class="col-md-12 control-label">Category Name<span class="text-red" style="color:red">*</span></label>
                     <div class="col-md-12">
                        <input type="text" name="category_name" required="" class="form-control" id="category_name" value="<?= set_value('category_name',$single['category_name']) ?>" placeholder="Enter Category Name">
                     ...
                     <div class="col-lg-3">
                        <div class="input-group">
                           <div class="image-input image-input-outline" id="kt_image_1">
                              <div class="image-input-wrapper" style="background-image: url(<?= base_url($single['category_image'] ); ?>)"></div>
