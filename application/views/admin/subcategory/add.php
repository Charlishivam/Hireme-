...
<div class="content-wrapper">
   ...
   <section class="content">
      <div class="card card-default">
         ...
         <div class="card-body">
            <form method="POST" action="<?= base_url()."admin/subcategory/add" ?>" enctype="multipart/form-data">

               <div class="card-body">
                  <div class="form-group row mt-3">
                     <label class="col-lg-2 col-form-label text-lg-right"><span class="text-red" style="color:red">*</span> State Name:</label>
                     <div class="col-lg-10">
                        <?= form_dropdown('category_id',$category_name,set_value('category_id'),'class="form-control" id="kt_select2_2"') ?>
                  ...
                  <div class="form-group row mt-3">
                     ...
                     <div class="col-lg-10">
                        ...
                        <input type="text" name="subcategory_name" required="" class="form-control" id="subcategory_name" value="<?= set_value('subcategory_name') ?>" placeholder="Subcategory Name">
