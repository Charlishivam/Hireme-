        ...
        <div class="box-head">
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="row">
                        <div class="col-md-5">
                            <input type="text" class="form-control form-control-sm" placeholder="Category Search..." v-model="search_keyword" />
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-1">
                            <a type="button" href="<?php echo base_url('secure/category/create') ?>" class="btn w-100 btn-info btn-sm"><i class='bx bx-plus-circle'></i></a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <template v-if="page_records.length > 0">
                        	<tr v-for="(r, idx) in page_records">
                        		...
                        		<td class="text-right pr-0">
                        			<a :href="base_url + 'secure/category/edit/' + r.slug" class="btn btn-icon">
                        				Edit
                        			</a>
                        			<a :href="base_url + 'secure/category/delete/' + r.slug" class="btn btn-icon delete">
                        				Delete
                        			</a>
                        		</td>
                        	</tr>
	...
	var pr = new Vue({
		...
		methods:{
			...
			loadPage:       function (csv_export = false) {
				...
				startProcess();
				$.post(base_url+'secure/category/fetch', data, function(response) {
			...
			exportData:function(records) {
				var csvData = 'Sr No.,Category, Slug, Icon, Status, Created At\n';
		...
		mounted: function() {
			startProcess();
			$.getJSON(base_url + 'secure/category/fetch', function () {
