...
<section class="bradcr bradcr-long">
	<div class="container-fluid mw-1200">
		<div class="row">
			<div class="col-6">
				<p class="breadcrumb-head">Template List</p>
			</div>
			<div class="col-6">
				<div class="breadcrumb-cstm text-right">
					<a href="#">Secure</a>
					<a href="#" class="breadcrumb-item">Template List</a>
        ...
        <div class="box-head">
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="row">
                        <div class="col-md-5">
                            <input type="text" class="form-control form-control-sm" placeholder="Template Search..." v-model="search_keyword" />
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-1">
                            <a type="button" href="<?php echo base_url('secure/template/create') ?>" class="btn w-100 btn-info btn-sm"><i class='bx bx-plus-circle'></i></a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <template v-if="page_records.length > 0">
                        	<tr v-for="(r, idx) in page_records">
                        		...
                        		<td class="text-right pr-0">
                        			<a :href="base_url + 'secure/template/edit/' + r.slug" class="btn btn-icon">
                        				Edit
                        			</a>
                        			<a :href="base_url + 'secure/template/delete/' + r.slug" class="btn btn-icon delete">
                        				Delete
                        			</a>
                        		</td>
                        	</tr>
	...
	var pr = new Vue({
		...
		methods:{
			...
			loadPage:       function (csv_export = false) {
				...
				startProcess();
				$.post(base_url+'secure/template/fetch', data, function(response) {
			...
			exportData:function(records) {
				var csvData = 'Sr No.,template, Slug, Icon, Status, Created At\n';
		...
		mounted: function() {
			startProcess();
			$.getJSON(base_url + 'secure/template/fetch', function () {
